...
import { LayoutDashboard, FolderOpen, Receipt, Plus, LogOut, User, ChevronDown, Menu, X, Sun, Moon } from "lucide-react"
      ...
      <nav className="container mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <Link href="/dashboard/projects/new" className="hidden sm:block">
            <Button size="sm" className="rounded-full gap-2 bg-foreground text-background hover:bg-foreground/90">
        ...
        <div className="md:hidden bg-background border-b border-border">
          <div className="container mx-auto px-4 py-4 flex flex-col gap-2">
            ...
            <Link
              ...
              onClick={() => setMobileMenuOpen(false)}
              className="flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium text-foreground bg-muted"
            >
              <Plus className="size-4" />
              New Project
            </Link>
